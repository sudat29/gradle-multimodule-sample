...
set CLASSPATH=%APP_HOME%\lib\client-1.0-SNAPSHOT.jar;%APP_HOME%\lib\producer-1.0-SNAPSHOT.jar;%APP_HOME%\lib\consumer-1.0-SNAPSHOT.jar

@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" org.indepth.gms.client.IntApplication %CMD_LINE_ARGS%
